              ...
              <div class="container">
                <nav class="navbar navbar-light navbar-expand-lg py-4">
                  <Link to="/">
                    ...
                    <a class="navbar-brand">
                      <h1 class="text-primary fw-bold mb-0">
                        Meal<span class="text-dark">Bridge</span>{" "}
                      </h1>
                    </a>
                  </Link>
                  <button
                  ...
                  <div class="collapse navbar-collapse" id="navbarCollapse">
                      ...
                      <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-light">
                          ...
                          <Link to="/manage-donations">
                            <a class="dropdown-item">Manage Donations</a>
                          </Link>
                          <Link to="/user-claims">
                            <a class="dropdown-item">View Claims</a>
                          </Link>
                        </div>
                      </div>
                    ...
                    <Link to="/logout">
                      {" "}
                      <a class="btn btn-primary py-2 px-4 d-none d-xl-inline-block rounded-pill">
                        Log Out
                      </a>
                    </Link>
                  </div>
                  ...
                  <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto">
                      ...
                      <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-light">
                          <Link to="/donate">
                            <a class="dropdown-item">Donate Food</a>
                          </Link>
                          <Link to="/findfood">
                            <a class="dropdown-item">Find Food</a>
                          </Link>
                        </div>
                      </div>
                      ...
                      <Link to="/impactracking">
                        {" "}
                        <a class="nav-item nav-link ">Impact tracking</a>
                      </Link>
                      <Link to="/dashboard">
                        {" "}
                        <a class="nav-item nav-link ">Badges</a>
                      </Link>
                    </div>
                    <button
                      class="btn-search btn btn-primary btn-md-square me-4 rounded-circle d-none d-lg-inline-flex"
                    ...
                    <Link to="/logout">
                      {" "}
                      <a class="btn btn-primary py-2 px-4 rounded-pill">
                        Log Out
                      </a>
                    </Link>
                  </div>
                ...
                <nav class="navbar navbar-light navbar-expand-lg py-4">
                  ...
                  <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto">
                      ...
                      <Link to="/chat">
                        {" "}
                        <a class="nav-item nav-link">Chat</a>
                      </Link>
                      <Link to="/contact">
                        {" "}
